# StateRestore for DataTables with Bulma styling
...
Installation from NPM can be done with the `datatables.net-staterestore-bm` package:

```
npm install \
    datatables.net-bm \
    datatables.net-buttons-bm \
    datatables.net-staterestore-bm
```
